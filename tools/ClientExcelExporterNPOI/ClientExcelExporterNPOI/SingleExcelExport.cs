...
namespace ClientExcelExporter
{
    class SingleExcelExport
    {
        ...
        public static void ReadXLS(string filetoread, string sheetName)
        {
            ...
            //string con = "Driver={Microsoft Excel Driver (*.xls)}; Dbq=" + filetoread + ";";
            ...
            using (FileStream file = new FileStream(filetoread, FileMode.Open, FileAccess.Read))
            {
            ...
            while (rows.MoveNext())
            {
                ...
                // Console.WriteLine("row.LastCellNum is " + row.LastCellNum);
                ...
                if (!initCol)
                {
                    ...
                    for (int j = 0; j < row.LastCellNum; j++)
                    {
                        ...
                        dtData.Columns.Add(cell.ToString());
                    }
                    continue;
                }
